...
ReadingHistory _$ReadingHistoryFromJson(Map<String, dynamic> json) => ReadingHistory(
...
Map<String, dynamic> _$ReadingHistoryToJson(ReadingHistory instance) => <String, dynamic>{
